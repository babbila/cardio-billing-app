...
export const CODES = [
  ...
  { code: '', cat: 'premiums', label: 'Callback code pairing rule', fee: '',
    notes: 'A genuine unscheduled callback always pairs an A-prefix service code with the matching premium — never a routine C-prefix code with an SVP premium. Admitting: A605+E082+K-premium. Seeing an existing inpatient off-hours as a callback (not rounds): A603/A601/A608 (or A605 for a fresh consult) + the matching C-prefix SVP premium (C990/994/986/996 series).' },
